...
Insert into
    product_type(type_id, name, unit)
values("1", "Produce", "lb");
...
Insert into
    manager (staff_id, start_date, store_id)
values ("10001", "2000-01-01", "1");

Insert into
    manager (staff_id, start_date, store_id)
values ("10003", "2001-05-01", "2");

Insert into
    manager (staff_id, start_date, store_id)
values ("10005", "2002-02-01", "3");
...
CREATE TABLE
    orders (
        ...
        date DATE NOT NULL,
        status VARCHAR(255),
        -- new, filled, pending delivery, delivered, completed
        customer_id INT,
        store_id INT,
...
Insert into
    freight_truck (license_plate, availability)
values ("XXX123", True);
